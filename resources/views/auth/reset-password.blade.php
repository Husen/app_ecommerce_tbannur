...
<head>
  <meta charset="utf-8" />
  <title>Reset Password E-Commerce TB. An-Nur</title>
                  ...
                  <div class="login-form login-signin">
                    ...
                    @csrf
                      ...
                      <div class="pb-13 pt-lg-0 pt-5">
                        ...
                        <p class="text-muted font-weight-bold font-size-h4">Masukan email anda dan buat password baru anda</p>
                      </div>
                      <!--end::Title-->
                      ...
                      <div class="form-group d-flex flex-wrap pb-lg-0">
                        <button type="submit" id="kt_login_forgot_submit" class="btn btn-primary font-weight-bolder font-size-h6 px-8 py-4 my-3 mr-4">Reset Password</button>
                      </div>
                      <!--end::Form group-->
                    </form>
                    <!--end::Form-->

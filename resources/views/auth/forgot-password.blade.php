...
<head><base href="../../../">
  <meta charset="utf-8" />
  <title>Lupa Password E-Commerce TB. An-Nur</title>
                  ...
                  <div class="login-form login-signin">
                    ...
                    @csrf
                      ...
                      <div class="pb-13 pt-lg-0 pt-5">
                        <h3 class="font-weight-bolder text-dark font-size-h4 font-size-h1-lg">Lupas Password ?</h3>
                        <p class="text-muted font-weight-bold font-size-h4">Masukan email anda yang terdaftar untuk mereset password</p>
                      </div>
                      <!--end::Title-->
                      <!--begin::Form group-->
                      ...
                      <div class="form-group d-flex flex-wrap pb-lg-0">
                        <button type="submit" id="kt_login_forgot_submit" class="btn btn-primary font-weight-bolder font-size-h6 px-8 py-4 my-3 mr-4">Send</button>
                        <a href="/login" class="btn btn-light-primary font-weight-bolder font-size-h6 px-8 py-4 my-3">Batal</a>
                      </div>
                      <!--end::Form group-->
                    </form>
                    <!--end::Form-->

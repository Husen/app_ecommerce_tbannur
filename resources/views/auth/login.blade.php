...
<head><base href="../../../">
  <meta charset="utf-8" />
  <title>Login E-Commerce TB. An-Nur</title>
      ...
      <div class="login-aside d-flex flex-column flex-row-auto" style="background-color: #0000;">
        ...
        <div class="login-content flex-row-fluid d-flex flex-column justify-content-center position-relative overflow-hidden p-7 mx-auto">
              ...
              <form method="POST" action="{{ route('login') }}">
                ...
                <div class="pb-13 pt-lg-0 pt-5">
                  ...
                  <span class="text-muted font-weight-bold font-size-h4">Belum daftar?
                    <a href="/register" class="text-primary font-weight-bolder">Klik Untuk Daftar Akun</a></span>
                  </div>
                  <!--begin::Title-->
                  <!--begin::Form group-->
                  <div class="form-group">
                    <label class="font-size-h6 font-weight-bolder text-dark">Email</label>
                    <input class="form-control form-control-solid h-auto py-6 px-6 rounded-lg" type="email" name="email" autocomplete="off" required />
                  </div>
                  <!--end::Form group-->
                  <!--begin::Form group-->
                  <div class="form-group">
                    <div class="d-flex justify-content-between mt-n5">
                      ...
                      <a href="forgot-password" class="text-primary font-size-h6 font-weight-bolder text-hover-primary pt-5" id="kt_login_forgot">Lupa Password ?</a>
                    </div>
                  ...
                  <div class="pb-lg-0 pb-5">
                    <button type="submit" class="btn btn-primary font-weight-bolder font-size-h6 px-8 py-4 my-3 mr-3">Masuk</button>
          ...
          <script type="text/javascript">            
            swal("Login Gagal!", "Email atau Password salah!", "error");
          </script>
          @enderror
        </body>
        <!--end::Body-->

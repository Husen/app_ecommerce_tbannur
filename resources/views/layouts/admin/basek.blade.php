...
<head>
	<meta charset="utf-8" />
	<title>Aplikasi Ecommerce</title>
							...
							<ul class="menu-nav">
								<li class="menu-item menu-item-open menu-item-here menu-item-submenu menu-item-rel menu-item-open menu-item-here menu-item-active" data-menu-toggle="click" aria-haspopup="true">
									<a href="/" class="menu-link menu-toggle">
										<span class="menu-text">Katalog Toko</span>
										<i class="menu-arrow"></i>
									</a>
								</li>
							</ul>
	...
	<div class="footer bg-white py-4 d-flex flex-lg-column" id="kt_footer">
		...
		<div class="container-fluid d-flex flex-column flex-md-row align-items-center justify-content-between">
			...
			<div class="text-dark order-2 order-md-1">
				...
				<a href="http://keenthemes.com/metronic" target="_blank" class="text-dark-75 text-hover-primary">Saidina H</a>
			</div>
			<!--end::Copyright-->
			<!--begin::Nav-->
...
<div id="kt_quick_user" class="offcanvas offcanvas-right p-10">
	...
	<div class="offcanvas-header d-flex align-items-center justify-content-between pb-5">
		...
		<!--end::Page Vendors-->
		<!--begin::Page Scripts(used by this page)-->
		<script src="{{ asset('assets/admin/js/pages/crud/datatables/basic/paginations.js') }}"></script>
		<!--end::Page Scripts-->
	</body>
	<!--end::Body-->
	</html>